...
.. class:: SceneGameData(bpy_struct)
   ...
   .. attribute:: activity_culling_box_radius
   ...
   .. attribute:: use_animation_record
   ...
   .. attribute:: use_material_caching
