...
.. function:: circle_select(x=0, y=0, radius=1, gesture_mode=0)
...
.. function:: select_border(pinned=False, gesture_mode=0, xmin=0, xmax=0, ymin=0, ymax=0, extend=True)
...
.. function:: smart_project(angle_limit=66.0, island_margin=0.0, user_area_weight=0.0, use_aspect=True, stretch_to_bounds=True)
   ...
   :file: `startup\bl_operators\uvcalc_smart_project.py\:1095 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup\bl_operators\uvcalc_smart_project.py$1095>`_
