...
.. function:: add_and_link_node(use_transform=False, settings=None, type="", link_socket_index=0)
...
.. function:: add_node(use_transform=False, settings=None, type="")
...
.. function:: add_search(use_transform=False, settings=None, type="", node_item='')
...
.. function:: select_border(gesture_mode=0, xmin=0, xmax=0, ymin=0, ymax=0, extend=True, tweak=False)
...
.. function:: viewer_border(gesture_mode=0, xmin=0, xmax=0, ymin=0, ymax=0, extend=True)
