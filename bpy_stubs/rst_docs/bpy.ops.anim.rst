...
.. function:: channels_select_border(gesture_mode=0, xmin=0, xmax=0, ymin=0, ymax=0, extend=True)
...
.. function:: clear_useless_actions(only_unused=True)
   ...
   :file: `startup\bl_operators\anim.py\:316 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup\bl_operators\anim.py$316>`_
...
.. function:: update_animated_transform_constraints(use_convert_to_radians=True)
   ...
   :file: `startup\bl_operators\anim.py\:349 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup\bl_operators\anim.py$349>`_
