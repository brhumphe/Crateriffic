...
.. function:: align(bb_quality=True, align_mode='OPT_2', relative_to='OPT_4', align_axis={})
   ...
   :file: `startup\bl_operators\object_align.py\:405 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup\bl_operators\object_align.py$405>`_
...
.. function:: randomize_transform(random_seed=0, use_delta=False, use_loc=True, loc=(0.0, 0.0, 0.0), use_rot=True, rot=(0.0, 0.0, 0.0), use_scale=True, scale_even=False, scale=(1.0, 1.0, 1.0))
   ...
   :file: `startup\bl_operators\object_randomize_transform.py\:171 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup\bl_operators\object_randomize_transform.py$171>`_
...
.. function:: transform_apply(location=False, rotation=False, scale=False)
...
.. function:: vertex_group_smooth(group_select_mode='', factor=0.5, repeat=1, expand=0.0, source='ALL')
