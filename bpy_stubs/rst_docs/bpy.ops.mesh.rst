...
.. function:: knife_tool(use_occlude_geometry=True, only_selected=False)
...
.. function:: primitive_torus_add(location=(0.0, 0.0, 0.0), view_align=False, layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False), rotation=(0.0, 0.0, 0.0), major_segments=48, minor_segments=12, mode='MAJOR_MINOR', major_radius=1.0, minor_radius=0.25, abso_major_rad=1.25, abso_minor_rad=0.75, generate_uvs=False)
